...
namespace Capa_Vista_ComboI
{
    public partial class ComboI : UserControl
    {
        ...
        public void llenarCombo(string _tabla, string _campo1, string _campo2, bool filtrarEstado = true)
        {
            var dtTabla = controlador.enviarDatos(_tabla, _campo1, _campo2, filtrarEstado);
